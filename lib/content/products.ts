 ...
 *
 * The `src` and `hoverSrc` images are still local because they're a
 * branded packshot + lifestyle treatment, not the same as the Shopify
 * product feed image. A future iteration can move these to Shopify too.
 */
...
export const PRODUCT_CONTENT: ProductContent[] = [
  {
    ...
    detailLine: "Targeted Body Recovery* - 24 patches - Daily Wear",
